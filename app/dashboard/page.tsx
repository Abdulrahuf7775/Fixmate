...
export default function DashboardPage() {
  ...
  const canRelease = booking ? ["completed", "accepted", "funded"].includes(booking.escrowStatus) : false;
              ...
              <>
                ...
                {booking && (
                  <div className="mt-5 grid gap-3 sm:grid-cols-3">
                    <button onClick={() => run("user_release")} disabled={!canRelease} className="bg-gray-950 px-4 py-3 text-sm font-bold text-white disabled:opacity-40">
                      Release Escrow
                    </button>
